classdef oephys < neurostim.plugins.ePhys
    ...
    % Example usage:
    %
    %   o = neurostim.plugins.oephys(c, 'oephys' [,HostAddr] [,RecDir] [,StartMsg] [,StopMsg] [,CreateNewDir] [,PrependText] [,AppendText])
    %
    ...
    %   RecDir - Directory used for saving open ephys generated continuous, spike and event files. 
            ...
            switch (computer)
                case 'PCWIN64' %Windows 64-bit
                    if exist('zeroMQrr.mexw64', 'file') == 0 
                        fileException = MException('oephys:missingDependency', 'The mex file zeroMQrr.mexw64 is not on MATLAB''s search path. <a href="https://github.com/open-ephys/plugin-GUI/tree/master/Resources/Matlab">Download</a>'); 
                        throw(fileException)
                    elseif exist('libzmq-v120-mt-4_0_4.dll', 'file') == 0 
                        fileException = MException('oephys:missingDependency', 'The library file libzmq-v120-mt-4_0_4.dll is not on MATLAB''s search path. <a href="https://github.com/open-ephys/plugin-GUI/tree/master/Resources/Matlab">Download</a>');
                        throw(fileException)
                    end
                    
                case {'GLNX86','GLNXA64'}
                    if exist('zeroMQrr.mexa64','file') ~= 3
                        fileException = MException('oephys:missingDependency', 'The mex file zeroMQrr.mexa64 is not on MATLAB''s search path. <a href="https://github.com/open-ephys/plugin-GUI/tree/master/Resources/Matlab">Download</a>'); 
                        throw(fileException)
                    end
                
                case 'MACI64' % OS X 64-bit
                    if exist('zeroMQrr.mexmaci64', 'file') == 0 
                        fileException = MException('oephys:missingDependency', 'The mex file zeroMQrr.mexmaci64 is not on MATLAB''s search path. <a href="https://github.com/open-ephys/plugin-GUI/tree/master/Resources/Matlab">Download</a>'); 
                        throw(fileException)
                    elseif exist('libzmq-v120-mt-4_0_4.dll', 'file') == 0 
                        fileException = MException('oephys:missingDependency', 'The library file libzmq-v120-mt-4_0_4.dll is not on MATLAB''s search path. <a href="https://github.com/open-ephys/plugin-GUI/tree/master/Resources/Matlab">Download</a>');
                        throw(fileException)
                ...
                otherwise 
                        fileException = MException('oephys:missingDependency', 'Please compile the zeroMQrr mex file for your OS (32-bit or 64-bit)'); 
                        throw(fileException)
            end
